...
$query2="UPDATE `opay_payment` SET `opay_status`='$msg',`time_cron`='$time',`channels`='Opay',`amount_r`='$koboToNaira',`progress`=50 WHERE `reference`='$reference'";
...
///////////////Optional
$query3="UPDATE `opay_payment` SET `progress`=75 WHERE `reference`='$reference'";
...
// }
  ...
  //mail("munzali@ratelplus.net","Opay callback",$customer_id." ".$sts." ".$handler);
    include 'ratelhelper_opay.php';
    exit();
