...
<body>
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <form method="POST" action="#">
                  ...
                  <div class="form-group">
                    <button type="submit" class="btn btn-primary btn-lg btn-block" tabindex="4" id="resetme">
                      Forgot Password
                    </button>
                  </div>
                   <span id="status"></span>
  ...
  $(document).ready(function(){
      $("#resetme").click(function(event){
        event.preventDefault();
        var email = $('#email').val();
         
      
        $.ajax({
            url: "actions/reset.php",
            method: "post",
            data: {resetme:1, email:email},
