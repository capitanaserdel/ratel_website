<?php //require_once("../../forms/phpmailer/class.phpmailer.php");
include '../../forms/phpmailer/class.phpmailer.php';
?>
<?php
$mail = new PHPMailer;
//$to="customercare@ratelplus.net.ng";
$from=$email;
...
$defaultPath = $mylogo.'<br>'.'The following is a message from: <a href="https://ratelplus.net">RatelPlus</a>';
    ...
    $subject =  $source2." {Manual Registration} ".$reference;
               ...
               if($source2=='Personal Subscriber'){//Paystack
...
<b>Request:</b> $source2<hr>

<b>Amount Paid:</b> &#8358;$amount<hr>

<b>Payment Source:</b> Paystack<hr>

<b>TimeStamp:</b> $timestmp<hr>

";

}elseif($source=='Business Subscriber'){//Business Subs Paystack
...
}elseif($source=='Business_Subscriber'){//Business Subs Paystack
