              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Error Recharge <i class="fas fa-times bg-danger text-white"></i></h4>
                  </div>
                  <div class="card-body">
                    <div class="table-responsive">
                     <div style="float:right;"><a href="error_airtime_advance.php">Advance Search</a></div>
...
$query = mysqli_query($config,"SELECT * FROM `opay_payment` where date(`timestamp`)=curdate() and `opay_status`='success' and switch_status is null order by `id` asc");
  $j=0;
while (($data = mysqli_fetch_assoc($query))){
  ...
  switch ($data["channels"]) {
    ...
    $link="https://ratelplus.net/ratelpay.php";
    break;
    default:
