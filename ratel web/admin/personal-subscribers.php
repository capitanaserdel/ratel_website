 ...
 $(document).ready(function(){
      $("#formData").submit(function(event){
        ...
        $.ajax({
            ...
            method: "post",
            data: {formData:1,pics1:pics1,pics2:pics2,mobile:mobile,fname:fname,sname:sname,gender:gender,email:email,loc:loc,nin:nin,addr:addr,source:source,amount:0,staff:staff},
