...
<td><div class="badge badge-info badge-shadow"><?php if(isset($data['close_balance'])and (!empty($data['close_balance']))){?><?php echo number_format($data['close_balance'],2); ?><?php }?></div></td>
<td><div class="badge badge-success badge-shadow"><?php if(isset($data['close_balance'])and (!empty($data['close_balance']))){?><?php echo number_format($data['close_balance']+$data['amount_r'],2); ?><?php }?></div></td>
