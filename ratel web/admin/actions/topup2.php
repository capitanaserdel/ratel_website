...
$query="INSERT INTO `opay_payment`(`reference`,`ratelnumber`,`opay_status`,`progress`,`devices_os`,`channels`,`staff`,`close_balance`,`bank_teller`)VALUES('$reference','$cus_number','INITIAL',25,'web','Ratel','$staff','$closeb','$bank')";
