<?php
// mail("munzali@ratelplus.net,munzalihassan030@gmail.com","Track switch_staus","STM");
// die;
require_once("../../forms/phpmailer/class.phpmailer.php");
$mail = new PHPMailer;
$rand=rand();
$sender="customercare@ratelplus.net";
 $mbody="Testing Mail Server".$rand;
 $email="munzalihassan030@gmail.com";
//////////////////////////
...
$mail->Password = 'smtp@2020';                         // SMTP password
$mail->SMTPSecure = 'ssl';
$mail->Port       = 465;  
...
$mail->addAddress('munzalihassan030@gmail.com', 'RatelPlus');               // Name is optional

$mail->isHTML(true); 
//$fullMessage="Testing Mail Server";                                 // Set email format to HTML 
