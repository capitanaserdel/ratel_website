      ...
      <div class="container">
        <nav class="breadcrumbs">
          <ol>
            ...
            <li class="current">Calling Card</li>
          </ol>
        </nav>
        <h1>Personal Subscribers Calling Card</h1>
      </div>
    </div><!-- End Page Title -->
    ...
    <!-- Portfolio Details Section -->
     <section id="pricing" class="contact section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Calling Card <span style="color:darkgreen;">(<?php echo "$formid Minutes"." @ "."&#8358;".$amountp;?>)</span></h2>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-4">
          <div class="col-lg-4">
  <img src="assets/img/sim.png"alt="" width="100%"style="border-radius: 25px;">
        </div>
        <div class="col-lg-8">
   ...
   <div class="col-md-6">
                ...
                <div class="col-md-6 ">
                  <input type="text" class="form-control" name="price" id="price" readonly="readonly" title="Calling Card" value="<?php echo $_POST['formid']." Minutes"; ?>" >
                </div>
                <div class="col-md-6">
...
<div class="col-md-6">
                ...
                <div class="col-md-6 ">
                  <input type="Number" class="form-control" name="nin" id="nin" placeholder="NIN Number " >
                </div>
               <div class="col-12">
                  <textarea class="form-control" name="addr" id="addr" rows="6" placeholder="Residential Address *" required=""></textarea>
                </div>
                <div class="col-12">
                  <hr>
                  <p><i onclick="document.getElementById('upload_image_background').click();">Upload the following Image(s) *</i></p>
                  <ol>
                  <li>e-passport, NIN slip, or driver's license ID</li>
                  <li>A recent picture of you</li>
                </ol>
                <hr>
                </div>
                <div class="col-md-12 ">
 ...
 $(document).ready(function(){
      $("#formData").submit(function(event){
        ...
        $.ajax({
            ...
            method: "post",
            data: {formData:1,pics1:pics1,pics2:pics2,mobile:mobile,price:price,fname:fname,sname:sname,gender:gender,email:email,loc:loc,nin:nin,addr:addr,source:source},
