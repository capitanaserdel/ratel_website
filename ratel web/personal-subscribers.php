      ...
      <div class="container">
        <nav class="breadcrumbs">
          <ol>
            ...
            <li class="current">Personal Subscribers</li>
          </ol>
        </nav>
        <h1>Personal Subscribers</h1>
      </div>
    </div><!-- End Page Title -->
    ...
    <!-- Portfolio Details Section -->
     <section id="pricings" class="contact section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Personal Subscribers</h2>
          <p>We usually respond within 5 minutes 8:00am to 10:00pm Nigerian time. <br>For instant response, kindly reach out using our chat.</p>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-4">
          <div class="col-lg-4">
  <img src="assets/img/phonecall.png"alt="" width="100%"style="border-radius: 25px;">
        </div>
        <div class="col-lg-8">
...
<div class="col-md-6">
  <input type="Number"  min="0" name="mobile" id="mobile" class="form-control" placeholder="Mobile Number *" required="">
                ...
                <div class="col-md-6 ">
                 <input type="text" class="form-control" name="nin" id="nin" placeholder="NIN Number">
                </div>
                <!--<div class="col-md-12">
 ...
 $(document).ready(function(){
      $("#formData").submit(function(event){
        ...
        $.ajax({
            ...
            method: "post",
            data: {formData:1,pics1:pics1,pics2:pics2,mobile:mobile,fname:fname,sname:sname,gender:gender,email:email,loc:loc,nin:nin,addr:addr,source:source,amount:1000},
